...
public class Trayecto {
	...
	public void eliminarDesdeEstacionAlFinal(String nombreEstacionDesde) throws TrenException {
		//falta lo de la primera estacion 
		Iterator<Estacion> it = this.recorrido.iterator();
		Boolean encontrado = false;
	...
	// TODO
	public void annadirNuevaEstacionDetrasDeOtra(String nombreEstacionBase, Estacion nuevaEstacion)
		...
		while (it.hasNext()) {
			...
			if(actual.getNombreEstacion().equals(nuevaEstacion.getNombreEstacion())){
            	throw new TrenException("Ya existe este nombre de estación en el recorrido.");
            }
            
            if(actual.getNombreEstacion().equals(nombreEstacionBase)){
